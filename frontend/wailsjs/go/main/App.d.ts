...
export function AuthorizeDocumentImages(arg1:string,arg2:string):Promise<void>;

export function Bootstrap():Promise<main.Bootstrap>;

export function CancelClose():Promise<void>;

export function CheckDocuments():Promise<Array<document.Change>>;
...
export function ListDirectory(arg1:string,arg2:string):Promise<document.DirectoryPage>;

export function ListDocumentTrash(arg1:string):Promise<Array<main.DocumentTrashItem>>;
...
export function NewDocument():Promise<document.Document>;

export function OpenDocument(arg1:string):Promise<document.Document>;

export function OpenExternal(arg1:string):Promise<void>;

export function OpenFolder(arg1:string):Promise<main.Bootstrap>;
...
export function ReadDocumentDisk(arg1:string):Promise<document.Document>;

export function RebuildIndex():Promise<main.Stats>;

export function ReloadDocument(arg1:string,arg2:string):Promise<document.Document>;

export function RememberDocuments(arg1:Array<config.DocumentState>,arg2:string):Promise<void>;

export function RenameDocument(arg1:string,arg2:string):Promise<document.Document>;
...
export function RestoreDocumentTrash(arg1:string,arg2:string):Promise<store.Restored>;
...
export function SaveDocument(arg1:string,arg2:string,arg3:string,arg4:boolean):Promise<document.Document>;

export function SaveDocumentAs(arg1:string,arg2:string):Promise<document.Document>;
...
export function TrashDocument(arg1:string):Promise<store.TrashItem>;
